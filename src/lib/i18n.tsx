...
const hi: Dict = {
  ...
  "nav.collage": "कोलाज मेकर",
  "nav.billing": "बिलिंग",
  "nav.signOut": "साइन आउट",
  "nav.language": "भाषा",

  "dash.hey": "नमस्ते",
  "dash.subtitle": "सभी 6 स्टूडियो तैयार हैं। नीचे से कोई एक चुनें और बनाना शुरू करें।",
...
const es: Dict = {
  ...
  "nav.collage": "Creador de Collages",
  "nav.billing": "Facturación",
  "nav.signOut": "Cerrar sesión",
  "nav.language": "Idioma",

  "dash.hey": "Hola",
  "dash.subtitle": "Los 6 estudios están listos. Elige uno abajo y empieza a crear.",
...
const fr: Dict = {
  ...
  "nav.collage": "Créateur de Collage",
